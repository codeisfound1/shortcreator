...
class VideoCreator:
    ...
    async def _generate_tts(self, text: str) -> Tuple[Optional[Path], list]:
        ...
        try:
            ...
            subscribe_cta = "Bạn nghĩ sao? Comment bên dưới, hãy like đăng ký kênh để xem được tin mới nhất! Yêu các bạn"
...
async def _main():
    try:
        ...
        max_per_channel = int(os.getenv("MAX_TELEGRAM_POSTS", 2))
